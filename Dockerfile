...
WORKDIR /opt/src
RUN wget https://github.com/NationalSecurityAgency/ghidra/releases/download/Ghidra_11.4.1_build/ghidra_11.4.1_PUBLIC_20250731.zip
RUN unzip ./ghidra_11.4.1_PUBLIC_20250731.zip
ENV GHIDRA_INSTALL_DIR="/opt/src/ghidra_11.4.1_PUBLIC/"
